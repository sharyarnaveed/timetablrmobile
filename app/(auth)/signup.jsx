    ...
    >
      ...
      >
        ...
        <View className="flex-row mb-8 bg-gray-100 rounded-full p-1">
          ...
          >
            <Text
              className={`text-center font-semibold ${activeTab === "student" ? "text-white" : "text-gray-600"
                }`}
            >
              Student
            </Text>
          ...
          >
            <Text
              className={`text-center font-semibold ${activeTab === "teacher" ? "text-white" : "text-gray-600"
                }`}
            >
              Teacher
            </Text>
...
const CustomCheckbox = ({ checked, onPress }) => (
  <TouchableOpacity
    onPress={onPress}
    className={`w-6 h-6 border-2 rounded mr-3 items-center justify-center ${checked ? "bg-black border-black" : "border-gray-400"
      }`}
  >
